...
# Define the three variants to be used for training/evaluation.
PREPROC_VARIANTS = {
...
def train_and_predict() -> None:
    ...
    for variant_name, variant_folder in PREPROC_VARIANTS.items():
        ...
        param_grid = {
            "regressor__regressor__alpha": [1e-4, 1e-3, 1e-2, 1e-1, 1, 10, 100, 1000],
        ...
        model_path = f"linear_regression_model_{variant_name}.pkl"
        ...
        predictions_dir = f"../data/predictions/linear_regression/{variant_name}"
    ...
    csv_path = "performance_metrics_linear_regression.csv"
